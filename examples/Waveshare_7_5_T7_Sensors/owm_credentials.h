...
#define MY_DNS 192,168,0,15

// Weather display's hostname
const char *Hostname = "Wetterstation_WZ";
...
const char *MQTT_HOST_P = "192.168.0.10";
const char *MQTT_USER_P = "";
const char *MQTT_PASS_P = "";

// Use your own API key by signing up for a free developer account at https://openweathermap.org/
String apikey       = "ed48d88c23922dc4cbcd005e2bff71dc";                      // See: https://openweathermap.org/  // It's free to get an API key, but don't take more than 60 readings/minute!
...
String City             = "My City";                      // Your home city See: http://bulk.openweathermap.org/sample/
...
#define TXT_START "Meine Wetterstation"
